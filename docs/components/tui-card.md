...
<div class="tui-card">
  ...
  <div class="tui-card-content">
    This is the content of the card. You can put any HTML elements here.
  </div>
</div>
```
...
[//]: # ()
[//]: # (You can also create cards without a title:)
...
[//]: # ()
[//]: # (You can customize the appearance of cards by modifying the CSS variables in your theme:)
...
[//]: # (  --vp-tui-card-bg: #f9f9f9;)

[//]: # (  --vp-tui-card-fg: #333;)

[//]: # (  --vp-tui-card-border-width: 1px;)

[//]: # (  --vp-tui-card-border-color: #ddd;)

[//]: # (  --vp-tui-card-title-bg: #f9f9f9;)

[//]: # (  --vp-tui-card-padding: 1.5rem;)

[//]: # (  --vp-tui-card-shadow: 0 2px 4px rgba&#40;0, 0, 0, 0.1&#41;;)
...
[//]: # ()
[//]: # (These variables allow you to control various aspects of the card's appearance, such as border radius, colors, padding, and shadow.)
